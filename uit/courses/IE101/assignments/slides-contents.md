...
|  STT |     MSSV | Họ Tên             |
| ---: | -------: | ------------------ |
|    1 | 25410171 | Lê Thị Tú Anh      |
|    2 | 25410179 | Giang Hải Chương   |
|    3 | 25410183 | Nguyễn Đào Anh Đạt |
|    4 | 25410193 | Nguyễn Minh Duy    |
|    5 | 25410204 | Trương Xuân Hậu    |
|    6 | 25410213 | Phan Chí Hiếu      |
|    7 | 25410220 | Vũ Huy Hoàng       |
|    8 | 25410239 | Phạm Tuấn Kiệt     |
|    9 | 25410240 | Nguyễn Tạ Quí Lan  |
|   10 | 25410244 | Nguyễn Thành Lộc   |
|   11 | 25410291 | Đinh Xuân Sâm      |
|   12 | 25410319 | Đặng Hữu Toàn      |
|   13 | 25410321 | Nguyễn Điền Triết  |
|   14 | 25410325 | Nguyễn Văn Trung   |
|   15 | 25410338 | Lê Anh Vũ          |
...
*"Collaboration, Openness, and Learning Mindset"*. (Hợp Tác, Cởi Mở và
Cầu Thị).
...
1.  **Khởi tạo (Initiation):** Xác định mục tiêu, phạm vi, phê duyệt
    (Project Charter).

2.  **Lập kế hoạch (Planning):** Thu thập yêu cầu, thiết kế, ngân sách,
    nguồn lực.

3.  **Thực hiện (Execution):** Coding, tích hợp module, tạo bản build.

4.  **Giám sát & Kiểm soát:** Testing, QA, quản lý rủi ro, theo dõi tiến
    độ.
